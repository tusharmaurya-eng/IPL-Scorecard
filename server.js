  ...
  try {
    ...
    if (current && current.game_id) {
      const detailCandidates = [
        `https://livescoreapi.thehindu.com/api/cricket/scorecard/${current.game_id}`,
        `https://livescoreapi.thehindu.com/api/cricket/match/${current.game_id}`,
        `https://livescoreapi.thehindu.com/api/cricket/commentary/${current.game_id}`,
        `https://livescoreapi.thehindu.com/api/cricket/ball-by-ball/${current.game_id}`
      ];
      for (const u of detailCandidates) {
        try { current.live_details = await fetchJson(u); break; } catch(_) {}
      }
    }
  } catch(_) {}
